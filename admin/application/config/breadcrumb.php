 ...
 * 
 */
$config['set_home'] = '<a href="'.site_url().'clients/welcome">Home</a>';
 ...
 * $config['delimiter'] = ' > ';
 */
$config['delimiter'] = '<span class="divider"> &raquo; </span>';
 ...
 */
$config['replacer'] = array('edit'=>'Manage Device','list'=>'Listings','do_upload'=>'Upload Complete','upload_step_1'=>'Download Template','welcome' =>array(''), 'checked' => array('Confirm Device Records'), 'check' => array('Calibration Check'), 'add' => array('Add New'), 'customers' => array('My Clients'), 'approve' => array('Provider Approved'), 'categories' => array('Work Description'));
 ...
 * Home > Search > Results
 */
$config['exclude_segment'] = array(0);
 ...
 */
$config['use_wrapper'] = FALSE;
$config['wrapper'] = '<ol class="breadcrumb">';
$config['wrapper_inline'] = '<li></li>';
