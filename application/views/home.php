        ...
        <div class="feature-img"><img src="img/feature-image.gif" class="img-responsive"></div>
         <?php 
          ...
          <div class="login-box" id="login-panel">
            ...
            <br />
            <img src="img/bullet.gif" width="17" height="17"> <a href="admin/clients/customers/add">Create an account</a><br />
            <img src="img/bullet.gif" width="17" height="17"> <a href="admin/clients/forgot_password">Forgotten username/password</a>v
